  ...
  return (
    <form className="flex flex-col py-10">
      ...
      <div className="flex flex-col py-6">
        ...
        <input className="w-[230px] h-10 lg:w-[342px] md:h-12 md:w-[342px] rounded-md border placeholder:px-3" placeholder="e.g  Johndoe@gmail.com"/>
      </div>
      <div className="flex flex-col">
        <label className="py-2">Phone no.</label>
        <input className="w-[230px] h-10 lg:w-[342px] md:w-[342px] md:h-12 rounded-md border placeholder:px-3" placeholder="e.g  080611****4" />
      </div>
