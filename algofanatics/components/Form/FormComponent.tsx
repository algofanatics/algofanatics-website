  ...
  return (
    <form className="flex flex-col py-10">
      <div className=" flex flex-col">
        ...
        <input className="w-[230px] h-10 lg:w-[342px] md:h-12 md:w-[342px] rounded-md border" />
      </div>
      ...
      <div className="flex flex-col">
        ...
        <input className="w-[230px] h-[40px] lg:w-[342px] md:w-[342px] md:h-12 rounded-md border" />
      </div>
